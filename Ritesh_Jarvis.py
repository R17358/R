...
def task():
    while True:
        ...
        if 'wikipedia' in query:
            ...
            print("i am invented by 2 student as a mini project. their names are Ritesh Pandit & Momin Ayesha")
            speak("i am invented by 2 student as a mini project. their names are Ritesh Pandit & Momin Ayesha")
